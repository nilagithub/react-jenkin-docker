...
$ wsl docker build -t my-reactapp . 

$ docker run -d -it –rm -p [host_port]:[container_port] –name=[container_name] [image_id/image_tag]

		docker run -it -p 3003:3000 --name=myreactapp techwithgio/react-app:latest

root@srv421903:~# docker ps
root@srv421903:~# docker stop c1d5ff27d177
root@srv421903:~# docker rm c1d5ff27d177
